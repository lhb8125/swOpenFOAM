...
#if(SWTIMER)
Timer::startTimer("swPBiCGSTAB Amul");
#endif
    // --- Calculate A.psi
    ...
    SW_AMUL_COARSE_RELATION_REDESIGNED(matrix_,
                            ...
                            0);
#if(SWTIMER)
Timer::endTimer("swPBiCGSTAB Amul");
#endif
...
#if(SWTIMER)
Timer::startTimer("swPBiCGSTAB reduce");
#endif
    if(UPstream::parRun())
    {
...
#if(SWTIMER)
Timer::endTimer("swPBiCGSTAB reduce");
#endif
...
#if(SWTIMER)
Timer::startTimer("swPBiCGSTAB precondition");
#endif
            // --- Precondition pA
            preconPtr->precondition(yA, pA, cmpt);
#if(SWTIMER)
Timer::endTimer("swPBiCGSTAB precondition");
#endif
