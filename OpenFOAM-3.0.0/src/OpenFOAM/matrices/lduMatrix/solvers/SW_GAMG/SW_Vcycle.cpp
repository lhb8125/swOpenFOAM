...
#if(SWTIMER)
Timer::startTimer("Vcycle restrictField");
#endif
...
#if(SWTIMER)
Timer::endTimer("Vcycle restrictField");
#endif
    }
...
#if(SWTIMER)
Timer::startTimer("Vcycle solveCoarsestLevel");
#endif
    // Solve Coarsest level with either an iterative or direct solver
...
#if(SWTIMER)
Timer::endTimer("Vcycle solveCoarsestLevel");
#endif
...
#if(SWTIMER)
Timer::startTimer("Vcycle prolongField");
#endif
...
#if(SWTIMER)
Timer::endTimer("Vcycle prolongField");
#endif
