...
{
#if(SWTIMER)
Timer::startTimer("scalingFactor");
Timer::startTimer("scalingFactor Amul");
#endif
    ...
    SW_AMUL_COARSE_RELATION_REDESIGNED(A,
                            ...
                            coarseLevel);
#if(SWTIMER)
Timer::endTimer("scalingFactor Amul");
#endif
...
#if(SWTIMER)
Timer::startTimer("scalingFactor reduce");
#endif
    if(UPstream::parRun())
    {
...
#if(SWTIMER)
Timer::endTimer("scalingFactor reduce");
Timer::endTimer("scalingFactor");
#endif
