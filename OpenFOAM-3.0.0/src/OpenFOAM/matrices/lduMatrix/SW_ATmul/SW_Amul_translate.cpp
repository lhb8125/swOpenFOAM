...
#if(SWTIMER)
Timer::startTimer("translate_matrix_matrix");
#endif
...
#if(SWTIMER)
Timer::endTimer("translate_matrix_matrix");
#endif
    return refill;
...
#if(SWTIMER)
Timer::startTimer("translate_refill_data");
#endif
...
#if(SWTIMER)
Timer::endTimer("translate_refill_data");
#endif
}
...
#if(SWTIMER)
Timer::startTimer("translate_refill_location");
#endif
...
#if(SWTIMER)
Timer::endTimer("translate_refill_location");
#endif
}
...
#if(SWTIMER)
Timer::startTimer("init_origin_location");
#endif
...
#if(SWTIMER)
Timer::endTimer("init_origin_location");
#endif
}
