...
#if(SWTIMER)
Timer::startTimer("Cheby PCG Amul");
#endif
...
Timer::endTimer("Cheby PCG Amul");
                ...
                #else
                {
                    ...
                    rd1_[1] = wApA;
#if(SWTIMER)
Timer::startTimer("Cheby PCG reduce");
#endif
                    if(UPstream::parRun())
                    {
...
#if(SWTIMER)
Timer::endTimer("Cheby PCG reduce");
#endif
                }
                #endif
            }
